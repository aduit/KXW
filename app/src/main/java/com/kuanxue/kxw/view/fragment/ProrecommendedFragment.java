...
import com.kuanxue.kxw.view.adapter.ProrecommendAdapter;
...
public class ProrecommendedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().getIntent().setData(Uri.parse("rong://io.rong.imkit.demo").buildUpon().appendPath("conversation").appendPath("private")
                .appendQueryParameter("targetId", targetId).appendQueryParameter("title", null).build());
        view = (View) inflater.inflate(R.layout.fragment_prorecommended, container, false);
        final SurfaceView viewHeader = (SurfaceView) view.findViewById(R.id.header);
        youtubeLayout = (YoutubeLayout) view.findViewById(R.id.dragLayout);
        mListview = (XListView) view.findViewById(R.id.lv_prorecommended);
        mList = new ArrayList<>();
        mList.add("a");
        mList.add("b");
        mList.add("c");
        mList.add("d");
        mList.add("e");
        mListview.setAdapter(new ProrecommendAdapter(getActivity(), mList, youtubeLayout));
        initView();
        radioGroup = (RadioGroup) getActivity().findViewById(R.id.bottomBar);
